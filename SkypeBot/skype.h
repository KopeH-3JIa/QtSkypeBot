...
typedef QMap<QString,QAxObject*> ChatsMap;
...
class Skype : public QAxObject
{
    Q_OBJECT
public:
    explicit Skype(QObject *parent = 0);
    ~Skype();
    const Client* getClient(){return client;}
    unsigned getChatsCount() const;
    QStringList getChatsNames() const;
...
public slots:
    void slotMessageSkype(IDispatch*, TChatMessageStatus);
    void slotException(int,QString,QString,QString);
private:
    Client *client;
    ChatsMap chats;
